...
//        sceneView.backgroundColor = UIColor.white
        ...
        sceneView.pointOfView = sphereNodeDic[0]
        
//        let cameraNode = SCNNode()
//        cameraNode.camera = self.camera
//        sceneView.pointOfView = cameraNode
//        cameraNode.position = SCNVector3(x: -3, y: 3, z: 3)
//        let constraint = SCNLookAtConstraint(target: sphereNodeDic[0])
...
//        selectedAtomLabel.backgroundColor = sceneView.backgroundColor
        selectedAtomLabel.isHidden = true
    }
